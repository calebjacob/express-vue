...
describe('notifications', () => {
  ...
  describe('closeAllErrorNotifications()', () => {
    it('closes all error notifications', () => {
      const { closeAllErrorNotifications, notifications, showNotification } = useNotifications();
  ...
  describe('hideNotification()', () => {
    it('hides notification with matching id', () => {
      const { hideNotification, notifications, showNotification } = useNotifications();
